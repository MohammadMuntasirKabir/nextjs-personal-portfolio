    ...
    <section className="py-12 border-y border-border/50 overflow-hidden relative">
      ...
      <div className="flex animate-marquee">
        {doubled.map((skill, i) => (
          <span
            key={i}
            className="mx-4 px-5 py-2 text-sm font-medium text-muted-foreground hover:text-primary transition-colors duration-300 cursor-default whitespace-nowrap shrink-0"
          >
            {skill}
          </span>
        ))}
